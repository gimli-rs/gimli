...
fn main() {
    for path in env::args().skip(1) {
        ...
        // the file while it is being read. See the `memmap2` documentation and take your
        // own precautions. `fs::read` could be used instead if you don't mind loading the
